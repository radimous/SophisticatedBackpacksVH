...
public class DiamondBackpackModel<T extends Entity> extends EntityModel<T> implements IBackpackModel {
	private static final ResourceLocation NO_TINT_TEXTURE = new ResourceLocation(SophisticatedBackpacks.MOD_ID, "textures/block/diamond_backpack_no_tint.png");
	private static final ResourceLocation MAIN_TINT_TEXTURE = new ResourceLocation(SophisticatedBackpacks.MOD_ID, "textures/block/diamond_backpack_main.png");
	private static final ResourceLocation ACCENT_TINT_TEXTURE = new ResourceLocation(SophisticatedBackpacks.MOD_ID, "textures/block/diamond_backpack_accent.png");
	private final ModelPart mainTint;
	private final ModelPart bothTints;
	private final ModelPart onlyMainTint;
	private final ModelPart straps;

	public DiamondBackpackModel(ModelPart root) {
		mainTint = root.getChild("mainTint");
		bothTints = root.getChild("bothTints");
		onlyMainTint = root.getChild("onlyMainTint");
	...
	public static LayerDefinition createBodyLayer() {
		...
		bothTints.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 16).addBox(-4.0F, -9.0F, 0.0F, 8.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.25F, -2.0F, -3.1416F, 0.0F, 3.1416F));

		PartDefinition straps = partdefinition.addOrReplaceChild("straps", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));
		straps.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -12.0F, -4.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.25F, -2.0F, -3.1416F, 0.0F, 3.1416F));

		PartDefinition onlyMainTint = partdefinition.addOrReplaceChild("onlyMainTint", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));
		onlyMainTint.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(21, 10).addBox(-4.0F, -10.0F, 0.0F, 8.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.25F, -2.0F, -3.1416F, 0.0F, 3.1416F));

		PartDefinition mainTint = partdefinition.addOrReplaceChild("mainTint", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));
		mainTint.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(24, 0).addBox(-1.0F, -9.0F, 5.0F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.25F, -2.0F, -3.1416F, 0.0F, 3.1416F));
	...
	public <L extends LivingEntity, M extends EntityModel<L>> void translateRotateAndScale(M parentModel, LivingEntity livingEntity, PoseStack poseStack, boolean wearsArmor) {
		...
		if (wearsArmor) {
			double zOffset = BackpackArmorOffsetsManager.getOffsets(ModItems.DIAMOND_BACKPACK.get(), livingEntity.getItemBySlot(EquipmentSlot.CHEST).getItem()).map(offsets -> offsets.z).orElse(0D);
	...
	public void render(PoseStack poseStack, MultiBufferSource buffer, int packedLight, int mainColor, int accentColor, Item backpackItem, RenderInfo renderInfo) {
		...
		onlyMainTint.render(poseStack, vertexBuilder, packedLight, OverlayTexture.NO_OVERLAY, mainRed, mainGreen, mainBlue, 1);
